            ...
            <div className="relative z-10 flex flex-col items-center max-w-xl w-full px-12">
                ...
                <div className="text-center space-y-6">
                    <h2 className="text-5xl font-black text-[var(--foreground)] italic tracking-tighter uppercase mb-4 leading-none">
                        Generating <span className="text-[var(--accent-primary)]">Content</span>
                    </h2>
                ...
                <div className="mt-16 w-full space-y-4">
                    <div className="flex justify-between items-end">
                        <span className="text-[8px] font-black text-[var(--foreground)]/20 uppercase tracking-[0.2em]">Loading Progress</span>
                ...
                <div className="mt-12 flex gap-8">
                    {['SECURE_LINK', 'CONTENT_LOAD', 'PLATFORM_ACTIVE'].map(label => (
